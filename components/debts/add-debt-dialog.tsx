        ...
        <Form {...form}>
          <form onSubmit={handleSubmit}>
            <DialogHeader>
              ...
              <DialogDescription>
                Registra una nueva deuda o pasivo en tu sistema financiero
              </DialogDescription>
            </DialogHeader>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="grid gap-2">
                    ...
                    <FormControl>
                      <Input id="entity_name" placeholder="Ej: Hipotecario, Carro, Prestamo" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="grid gap-2">
                    ...
                    <FormControl>
                      <Input id="original_amount" type="text" inputMode="decimal" placeholder="0.00" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="grid gap-2">
                    ...
                    <FormControl>
                      <Input id="current_balance" type="text" inputMode="decimal" placeholder="0.00" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="grid gap-2">
                    ...
                    <FormControl>
                      <Input id="monthly_payment" type="text" inputMode="decimal" placeholder="0.00" {...field} />
                    </FormControl>
                    <p className="text-xs text-muted-foreground">
                      Define el valor total a pagar por periodo.
                    </p>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="grid gap-2">
                    ...
                    <FormControl>
                      <Input id="payment_day" type="text" inputMode="numeric" placeholder="Ej: 15" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="grid gap-2">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Mensual = 1 cuota al mes, Quincenal = 2 cuotas por mes.
                  </p>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="grid gap-2">
                  ...
                  <FormControl>
                    <Input id="interest_rate" type="text" inputMode="decimal" placeholder="Ej: 2.5" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
